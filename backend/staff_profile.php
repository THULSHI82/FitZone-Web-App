...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    [$success_message, $error_message, $username] = update_profile($conn, $username, 'staff');
    $_SESSION['user'] = $username;
}
$staff = load_profile($conn, $username, 'staff');
...
<head>
    ...
    <style>
        body {
            background-color: rgba(201, 193, 193, 1);
            color: white;
        }
        .sidebar {
            height: 100vh;
            ...
            width: 250px;
            overflow-y: auto;
            border-right: 2px solid rgba(251, 20, 251, 1);
        }
        .sidebar h3 {
        ...
        .card {
            background-color: rgba(7, 7, 77, 1);
            border: 1px solid rgba(19, 5, 208, 1);
            color: white;
            border-radius: 10px;
        ...
        .form-label {
            color: rgba(251, 20, 243, 1);
        }
        .btn-primary {
            background-color: rgba(251, 20, 239, 1);
            border: none;
            color: rgb(1, 1, 14);
        }
        .btn-primary:hover {
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="staff_profile.php">
