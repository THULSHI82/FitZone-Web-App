...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    [$success_message, $error_message, $username] = update_profile($conn, $username, 'admin');
    $_SESSION['user'] = $username;
}
$admin = load_profile($conn, $username, 'admin');
...
<head>
    ...
    <style>
        body {
            background-color: rgba(206, 192, 192, 1);
            color: white;
        }
        .sidebar {
            height: 100vh;
            ...
            width: 250px;
            overflow-y: auto;
            border-right: 2px solid rgba(251, 20, 243, 1);
        }
        .sidebar h3 {
        ...
        .card {
            background-color: rgba(6, 6, 65, 1);
            border: 1px solid rgba(5, 63, 208, 1);
            color: white;
            border-radius: 10px;
            box-shadow: 0 4px 6px rgba(0, 0, 0, 0.5);
        }
        .card-title {
            color: rgba(251, 20, 216, 1);
            font-weight: bold;
        }
        .form-label {
        ...
        .btn-primary:hover {
            background-color: rgba(200, 15, 166, 1);
        }
    </style>
</head>
<body>
